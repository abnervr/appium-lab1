...
public class BookstoreTest {
	...
	public void afterTest() throws Exception {
        ...
        FileUtils.copyFile(scrFile, new File("./screenshots/Android_" + BookstoreTest.class.getSimpleName() + "_" + testName.getMethodName()+ ".jpg"));
		...
		pic.setAutofit(true);
		pic.writeAll(graph, "screenshots/Graph_" + BookstoreTest.class.getSimpleName() + "_" + testName.getMethodName() + ".jpg");
	}
